...
object SLL       extends OPIInstruction    { val props = Seq(F6(OPIFunct6.sll)     , UsesShift.Y, ShiftsLeft.Y, ScalingShift.N, ZextImm5.Y) }
object SRA       extends OPIInstruction    { val props = Seq(F6(OPIFunct6.sra)     , UsesShift.Y, ShiftsLeft.N, ScalingShift.N, ZextImm5.Y) }
...
object SSRA      extends OPIInstruction    { val props = Seq(F6(OPIFunct6.ssra)    , UsesShift.Y, ShiftsLeft.N, ScalingShift.Y, ZextImm5.Y) }
...
object RORI       extends OPIInstruction    { val props = Seq(F6(OPIFunct6.rol)      , UsesShift.Y, ShiftsLeft.N, ScalingShift.N) }
